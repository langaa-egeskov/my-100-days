...
<html>
  <head>
     ...
     <link href="//cdn.muicss.com//mui-0.9.28/css/mui.min.css" rel="stylesheet" type="test/css" />
     <link href="static/css/style.css" rel="stylesheet" type="test/css" />
  ...
  <div id="sidebar">
    ...
    <div class="mui--text-light mui--text-display1 mui--align-vertical">
      <a href="https://twitter.com/python_tip" target="_blank">
        <img class="logo" scr='https://pbs.twimg.com/profile_images/828169453095510016/X0iDPdDL_400x400.jpg' alt='PyBites'>
      </a>
      <a hfef="https://pybit.es" target="_blank">
      ...
      <ul class="mui-dropdown_menu">
              <li><a href="https://twitter.com/bbelderbos" target="_blank">Created by @bbelderbos (@pybites)</a></li>
              <li><a href="https://pybit.es/codechallege40.html" target = "_blank">Build for PyBites Challenge #40</a></li>
